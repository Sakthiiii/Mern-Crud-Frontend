...
import { getUserDetails, updateUser, clearDetails } from "../actions";
...
const UpdateUser = ({ match }) => {
  ...
  const submitInfo = () => {
    if (nameValid && ageValid && emailValid) {
      ...
      dispatch(updateUser(match.params.id, person));
  ...
  return (
    <>
      ...
      <Modal show={isOpen}>
        <Modal.Header>Update User {details.name}</Modal.Header>
        <Modal.Body>
